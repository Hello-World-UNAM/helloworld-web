-- Follow-up to the already installed expand-only migration. Feature remains off.
...
alter table private_selection.messages add constraint selection_delivery_status_check check(delivery_status in ('pending','sent','delivered','bounced','delayed','failed','complained'));
